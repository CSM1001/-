...
//	NSString* uploadDirPath = [[config documentRoot] stringByAppendingPathComponent:@"upload"];
    ...
    if( [[NSFileManager defaultManager] fileExistsAtPath:filePath] ) {
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message: [NSString stringWithFormat:@"%@上传成功",filename]preferredStyle:UIAlertControllerStyleAlert];
